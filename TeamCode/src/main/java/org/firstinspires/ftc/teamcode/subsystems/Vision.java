...
public class Vision {
    ...
    private double cameraToRealityRatio = 1;
//
...
//    }
    ...
    public double getSamplePosition(double defaultValue,int resultType){
        ...
        if (result != null) {
            ...
            irlY = Math.tan(Math.toRadians(tX + 45)) * cameraToRealityRatio;
            irlX = (Math.tan(Math.toRadians(tY)) * cameraToRealityRatio)- cameraOffset;
            if(resultType == 0){
                return irlX;
            }
            else{
